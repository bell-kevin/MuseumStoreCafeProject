...
public class MuseumStoreCafe 
{
    public static void main(String[] args) 
    {
        ...
        System.out.println("Module 4 Compentency Exercise by JC Boyd\n");
        ...
        switch (answer)
        {
            case 1: searchTerm = "entree"; break;
            case 2: searchTerm = "side"; break;
            case 3: searchTerm = "drink"; break;
            case 4: searchTerm = "dessert"; break;
        } //end switch
        for (Item obj : menu)
            {
